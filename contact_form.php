...
<body>
    ...
    if($result){
        ...
        //To not to show the error to the error th the user.
        // echo "<br>The record was not submitted successfully because of this error....." . mysqli_error($conn);
        echo  '<div class="alert alert-danger alert-dismissible fade show" role="alert">
        <strong>Error!</strong>Your entry was not submitted successfully! We are facing some issue... Sorry for the inconvenience caused!
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true">&times;</span>
        </button>
        </div>';
